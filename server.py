...
class Game:
    ...
    def check_winner(self) -> str:
        ...
        b = self.board
        lines = [
            [b[0][0], b[0][1], b[0][2]], [b[1][0], b[1][1], b[1][2]], [b[2][0], b[2][1], b[2][2]], # שורות
            [b[0][0], b[1][0], b[2][0]], [b[0][1], b[1][1], b[2][1]], [b[0][2], b[1][2], b[2][2]], # עמודות
            [b[0][0], b[1][1], b[2][2]], [b[0][2], b[1][1], b[2][0]] # אלכסונים
        ]
        for line in lines:
